  ...
  const helpBody = () => {
    return (
      <Fragment>
        ...
        <div className='helpHeader'>
          Switch between Hierarchical and Flat modes
        </div>
        <div className='helpPara'>
        ...
        <div className='helpPara'>
          If you want to create a copy of an existing list and all its items, go to the list page, press the "Changes to List" button, then press "Copy This List."  You can edit the name of the new list, then press "Copy Current List" to create the new list.
        </div>
        <div className='helpHeader'>
          Switch categories for a list
        </div>
        <div className='helpPara'>
