...
export const API_PROF = API_BASE + '/profilebyuser/';         // for editing
...
export const API_PROF_UN = API_BASE + '/profilebyusername/';  // initial fetch
export const API_REG = API_BASE + '/newuser678/';             // new user registration
export const API_IS_USER = API_BASE + '/isuser/';             // avoid duplicate usernames
